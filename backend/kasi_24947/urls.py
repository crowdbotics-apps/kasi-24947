...
admin.site.site_header = "kasi"
admin.site.site_title = "kasi Admin Portal"
admin.site.index_title = "kasi Admin"

# swagger
api_info = openapi.Info(
    title="kasi API",
    default_version="v1",
    description="API documentation for kasi App",
)
